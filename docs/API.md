...
**Prefix**: `/api/dashboard` (Returns mock data pending frontend implementation)

### `GET /api/dashboard/summary`
Get high-level summary statistics including active sessions and flagged rate.

### `GET /api/dashboard/risk-distribution`
Get count of sessions in each risk category.

### `GET /api/dashboard/trends`
Get trend data for a specified period.

### `GET /api/dashboard/flagged-sessions`
Get list of flagged sessions.

### `GET /api/dashboard/exam-analytics/{exam_id}`
...
Securely execute Python code with a timeout.
...
WebSocket connection for real-time monitoring of a specific session.

### `WS /ws/admin`
WebSocket connection for admin real-time monitoring of all sessions.
