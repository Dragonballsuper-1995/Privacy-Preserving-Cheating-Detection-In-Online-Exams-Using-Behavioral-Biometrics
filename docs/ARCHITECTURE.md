...
│  │  │              │  │              │  │                      │   │   │
│  │  │  /auth       │  │  keystroke   │  │  BehaviorAnomaly     │   │   │
│  │  │  /events     │──►  hesitation  ├──►  Detector            │   │   │
│  │  │  /sessions   │  │  paste       │  │  (Isolation Forest)  │   │   │
│  │  │  /exams      │  │  focus       │  │                      │   │   │
│  │  │  /analysis   │  │  pipeline    │  │  RiskFusionModel     │   │   │
│  │  │  /dashboard  │  │              │  │  (Weighted Ensemble) │   │   │
│  │  │  /code       │  │              │  │                      │   │   │
│  │  │  /ws         │  │              │  │                      │   │   │
│  │  └──────────────┘  └──────────────┘  └──────────────────────┘   │   │
│  └─────────────────────────────────────────────────────────────────┘   │
...
|--------|------|----------------|
| `app/api/auth_routes.py` | `/api/auth` | User registration and authentication |
...
| `app/api/dashboard.py` | `/api/dashboard` | Admin dashboard analytics |
| `app/api/code_execution.py`| `/api/code` | Sandboxed Python code execution |
| `app/api/websocket.py` | `/ws` | Real-time monitoring via WebSockets |
