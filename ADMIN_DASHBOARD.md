...
| Endpoint | Purpose |
|----------|---------|
| `GET /api/analysis/dashboard` | Session list with scores |
| `POST /api/analysis/analyze` | Session detail |
| `GET /api/analysis/timeline/{session_id}` | Event timeline |
| `GET /api/analysis/features/{session_id}` | Extracted features |

---

## Risk Scoring Formula

Displayed in the dashboard (from `analysis.py`):
